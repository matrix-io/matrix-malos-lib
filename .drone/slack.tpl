{{#success build.status}}
  ...
  :new: {{build.message}}
  :debian: `libmatrixio-malos_%%DISTRIBUTION%%-%%CODENAME%%-%%PKG_VER%%-%%COMPONENT%%_armhf.deb` 
  :debian: `libmatrixio-malos-dev_%%DISTRIBUTION%%-%%CODENAME%%-%%PKG_VER%%-%%COMPONENT%%_armhf.deb` 
